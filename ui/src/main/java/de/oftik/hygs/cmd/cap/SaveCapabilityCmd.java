...
public class SaveCapabilityCmd extends AbstractCommand {
	...
	public PreparedStatement prepare(Connection conn) throws SQLException {
		final PreparedStatement stmt = update(conn, CapabilityTable.TABLE, CapabilityColumn.cap_id, Arrays
				.asList(CapabilityColumn.cap_category_id, CapabilityColumn.cap_name, CapabilityColumn.cap_version));
